    ...
    <div className="rounded-2xl border border-gray-200 bg-white p-8 shadow-lg">
              ...
              <div className="h-4 w-full bg-gray-200 rounded-full overflow-hidden">
                <div
                  className={`h-full rounded-full transition-all duration-700 ${
                    isLeading ? 'bg-gradient-to-r from-green-500 to-emerald-500' : 'bg-gradient-to-r from-blue-500 to-indigo-500'
                  }`}
      ...
      <div className="mt-8 pt-8 border-t border-gray-200">
        <div className="flex flex-wrap items-center justify-center gap-6 text-sm">
          <div className="flex items-center">
            <div className="h-3 w-8 rounded-full bg-gradient-to-r from-blue-500 to-indigo-500 mr-2"></div>
            <span className="text-gray-600">Option results</span>
          </div>
          <div className="flex items-center">
            <div className="h-3 w-8 rounded-full bg-gradient-to-r from-green-500 to-emerald-500 mr-2"></div>
            <span className="text-gray-600">Currently leading</span>
          </div>
          {subscriptionEnabled && (
            <div className="flex items-center">
              <div className="h-3 w-3 rounded-full bg-green-500 mr-2 animate-pulse"></div>
      ...
      {totalVotes === 0 && !loading && (
        <div className="mt-8 text-center py-12">
          ...
          <h3 className="text-lg font-medium text-gray-900">Waiting for votes</h3>
